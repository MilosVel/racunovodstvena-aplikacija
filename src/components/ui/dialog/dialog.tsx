...
>(({ className, lightBackdrop, ...props }, ref) => (
...
>(({ className, lightBackdrop, children, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay lightBackdrop={lightBackdrop} />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ...
    ref={ref}
    className={cn(
      'text-lg leading-none tracking-tight focus:outline-none',
      className,
    )}
    {...props}
  />
